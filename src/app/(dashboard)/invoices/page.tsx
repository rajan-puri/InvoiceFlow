...
export default function InvoicesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters Bar */}
      <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center gap-3">
        ...
        <div className="grid grid-cols-2 sm:flex items-center gap-2 w-full sm:w-auto">
          <select
            ...
            className="text-xs font-medium px-2.5 sm:px-3 py-2 border border-slate-300 rounded-lg bg-white text-slate-700 w-full sm:w-auto"
          >
      ...
      {/* Invoices Listing: Desktop Table & Mobile Cards */}
              ...
              {invoices.map((inv) => (
                <div key={inv.id} className="p-4 space-y-3 hover:bg-slate-50/50 transition-colors">
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      {inv.clientContactPerson && (
                        <p className="text-xs text-slate-500 truncate">{inv.clientContactPerson}</p>
                      )}
                    </div>
                  ...
                  <div className="flex items-center justify-end gap-2 pt-1 border-t border-slate-100">
                    <Link
                      href={`/invoices/${inv.id}`}
                      className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium text-slate-600 bg-slate-100 hover:bg-slate-200"
                    >
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium text-amber-700 bg-amber-50 hover:bg-amber-100 border border-amber-200"
                    >
